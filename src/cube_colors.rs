use bevy::{
    ...
    prelude::*,
    reflect::TypePath,
    render::{render_resource::AsBindGroup, render_resource::*, storage::ShaderStorageBuffer},
    shader::ShaderRef,
};
...
fn setup(
    ...
    let mut shader_storage_buffer = ShaderStorageBuffer::from(color_data);
    shader_storage_buffer.buffer_description.usage =
        BufferUsages::STORAGE | BufferUsages::COPY_DST | BufferUsages::COPY_SRC;

    let colors = buffers.add(shader_storage_buffer);
